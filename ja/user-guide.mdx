---
title: "操作手順"
description: "フォルダ作成、コンテンツ追加、エージェント添付、削除までのステップバイステップ手順。"
icon: list-ol
---

<Note>
  Infobase が初めての方は、先に[はじめに](/ja/index)と[制限事項と更新](/ja/limitations)をお読みください。
</Note>
