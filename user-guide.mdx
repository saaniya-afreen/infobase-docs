---
title: "User guide"
description: "Step-by-step instructions to create folders, add content, attach agents, and delete Infobase items."
icon: list-ol
---

<Note>
  New to Infobase? Read the [Introduction](/index) and [Limitations](/limitations) first.
</Note>
